...
[abstract]
Les rapports d'évaluations sont accéssible depuis la partie 4. (Livrable) de ce README
...
| 3    | link:src/main/java/iut/sae/algo/Sobriete.c[sobriete C]           | C        | Sobriete
|==========================================================================
...
link:rapport/Simplicite.adoc[Rapport d'évaluation Simplicité] +
link:rapport/Efficacite.adoc[Rapport d'évaluation Efficacité] + 
link:rapport/Sobriete.adoc[Rapport d'évaluation Sobriété] +
